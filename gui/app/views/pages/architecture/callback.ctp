<?php 
/****************************************************************************
 * callback.ctp	- Architecture: Links to components, show Callback illustration
 * version 	- 1.0.356
 * 
 * Version: MPL 1.1
 *
...
$this->pageTitle = __('Architecture : Callback',true);           
echo "<h1>".__('Architecture: Callback',true)."</h1>";
...
echo $html->image('illustrations/freedomfone_v1.0_architecture_callback.png', array('title' => __('Callback architecture',true),'border'=>0,'width'=>'850px'))
