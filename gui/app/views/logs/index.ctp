...
echo $html->addCrumb(__('Logs',true), '/logs');
	...
	$opt = array('poll'=>__('Poll',true),'bin' => __('SMS',true),'message'=>__('Message Centre',true),'ivr' => __('IVR Centre',true),'cdr' => __('CDR',true), 'monitor_ivr' => __('Monitoring',true), 'process' => __('Health',true), 'refresh' => __('Cron and refresh',true), 'debug'=> __('Debug',true),'error' => __('Error',true));
