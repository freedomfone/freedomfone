...
<title><?php echo $title_for_layout?></title>
   ...
   <?=$html->css('customise');?>  		<!-- Freedom Fone -->
    ...
    <?=$html->css('jquery.jqplot.min.css');?>
...
<?=$this->Html->script(array('jquery-1.4.4.min','jquery.jqplot.min'));?>
<?=$this->Html->script(array('jquery-ui.min','jqplot.categoryAxisRenderer.min','jqplot.dateAxisRenderer.min'));?>
<?=$this->Html->script(array('jqplot.barRenderer.min','jqplot.canvasAxisTickRenderer.min','jqplot.highlighter.min'));?>
<?=$this->Html->script(array('jqplot.cursor.min','jqplot.pointLabels.min','jqplot.pieRenderer.min'));?>
<?=$this->Html->script(array('jqplot.donutRenderer.min','ff'));?>
<?=$this->Html->script(array('jqplot.canvasTextRenderer.min.js'));?>
...
<div id="wrapper">
   ...
   echo $this->Html->image("icons/login.png", array("class" => "logout", "alt" => __("Login",true), "title" => __("Login",true), "url" => array("controller" => "ff_users", "action" => "login")));
	 ...
	 <div class="footer1"><?php echo VERSION_NAME." ".VERSION; ?>
