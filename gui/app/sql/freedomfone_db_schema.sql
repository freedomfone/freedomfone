...
INSERT INTO `processes` VALUES (1,'dispatcher_in',0,'dispatcher_in/dispatcherESL.php --log=/opt/freedomfone/log/dispatcher_in.log > /dev/null 2>&1 & echo $!',100,'Incoming dispatcher',0,0,'Unmanaged','run','/usr/bin/php'),(2,'dispatcher_out',0,'dispatcher_out/dispatcher_out.php > /dev/null 2>&1 & echo $!',100,'Outgoing dispatcher',0,0,'','run','/usr/bin/php'),(3,'dispatcher_in_version',NULL,'dispatcher_in/dispatcherESL.php -V',100,'Incoming dispatcher version',0,0,NULL,'version','/usr/bin/php');
...
INSERT INTO `settings` VALUES (1,'language',0,'eng',0,'env'),(2,'length',0,NULL,20,'lam'),(3,'silence',0,NULL,60,'lam'),(4,'domain',0,'http://demo.freedomfone.org',0,'env'),(5,'ip_address',0,'127.0.0.1',0,'env'),(6,'timezone',0,'Africa/Harare',250,'env'),(7,'overwrite_event',0,'',1,'env'),(8,'country',0,'239',0,'env'),(9,'prefix',0,NULL,263,'env');
...
CREATE TABLE `users` (
  ...
  `count_callback_sms` int(11) unsigned default NULL,
  `count_callback_tickle` int(11) unsigned default NULL,
  `count_campaign` int(11) unsigned default NULL,
  `first_app` varchar(25) default NULL,
  `first_epoch` int(11) unsigned default NULL,
  `last_app` varchar(25) default NULL,
