...
class FfUser extends AppModel {
    ...
    public function beforeSave($options = array()) {
          ...
          $this->data['FfUser']['password'] = AuthComponent::password($this->data['FfUser']['password']);
          return true;
    }
...
function __construct($id = false, $table = null, $ds = null) {
  ...
  function bindNode($user) {
    ...
    $res = $this->findByUsername($user['FfUser']['username']);
//    return array('model' => 'Group', 'foreign_key' => $res['FfUser']['group_id']);
