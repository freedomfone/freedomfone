...
//
include("/opt/freeswitch/scripts/freedomfone/leave_message/" + lmId + "/conf/" + lmId + ".conf");
// We retrieve global variables as BaseDir and Domain Name
include("/opt/freeswitch/scripts/freedomfone/leave_message/" + lmId + "/conf/" + lmId + "_core.conf");
