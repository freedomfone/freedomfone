...
class UsersController extends AppController{
 		...
 		$this->set(compact('acls','phonebook','phonenumbers','neighbors'));
	      ...
	      //Save form data
		     ...
		     if($this->User->saveAll($this->request->data)){
                                 $this->log("INFO EDIT {ID: ".$id."; NAME: ".$this->request->data['User']['name']." ".$this->request->data['User']['surname']."}", "user");                       
	...
	if (array_key_exists('User', $this->request->data)) {
		...
		if ($this->User->save($this->request->data['User'])) {
                        ...
                        $this->User->PhoneNumber->saveAll($this->request->data['PhoneNumber']);
    ...
    function disp (){
	  ...
	  Configure::write('debug', 0);
          ...
          if( $phone_book_id = $this->request->data['User']['phone_book_id']){
