...
echo $this->Html->addCrumb(__('About',true), '/processes/system');
 ...
 $string = $os.', '.$release[1].', '.$lsb[1];
   ...
   foreach($settings as $key => $entry){
     ...
     if (isset($items)){
	  ...
	  if($key<5){	  
              $rss[] =  array($this->Html->div('news',$this->Html->link($item->get_title(), $item->get_permalink()))); 
	  }
        }
        echo $this->Html->tableCells($rss,array('class' =>'stand-alone'),array('class' =>'stand-alone'));

    } else {

        echo $this->Html->tableCells(array(__("There are no software updates available",true)),array('class' =>'stand-alone'),array('class' =>'stand-alone'));
    ...
    echo "</table>"; 
     ...
     echo "<table width='70%' cellspacing = 0 class='stand-alone'>";
     echo $this->Html->tableCells($row0 ,array('class' =>'stand-alone'),array('class' =>'stand-alone'));
     echo "</table>"; 
    ...
    echo "<table width='70%' cellspacing = 0 class='stand-alone'>";
    echo $this->Html->tableCells($row2,array('class' =>'stand-alone'),array('class' =>'stand-alone'));
    echo "</table>"; 
