...
echo $this->Html->addCrumb(__('Delete',true), '/monitor_ivr/delete');


echo "<h1>".__("Delete monitoring data",true)."</h1>";
echo $this->Form->create('MonitorIvr',array('type' => 'post','action'=> 'delete'));
...
echo $this->Form->end(array('name' => __('Delete',true), 'label' =>__('Delete',true),'class' =>'button'));
