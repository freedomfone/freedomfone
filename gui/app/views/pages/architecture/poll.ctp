<?php 
$this->pageTitle = 'Architecture : Poll';           
echo "<h1>Architecture: Poll</h1>";
...
echo $html->image('illustrations/freedomfone_v1.0_architecture_poll.png', array('alt' => 'Poll architecture','border'=>0,'width'=>'850px'))
